...
/**
 * @param props
 *      tabNo [number]: When tab number is equal to tabNo, this tab activates. (Higher z-index and Dark Color)
 *      tab [number]: the currently selected tab number.
 *      setTab [function]: sets state for tab to this tab's tabNo.
